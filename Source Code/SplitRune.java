...
public class SplitRune extends Entity {

	public SplitRune(Vector position, Vector dimension, BulletStage stage) {
	...
	public void collideAlly(Entity e) {
		PlayerSettings.getInstance().addRune(PlayerSettings.SPLIT_RUNE);
		this.despawn();
	}
}

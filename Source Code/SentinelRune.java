...
public class SentinelRune extends Entity {

	public SentinelRune(Vector position, Vector dimension, BulletStage stage) {
	...
	public void collideAlly(Entity e) {
		PlayerSettings.getInstance().addRune(PlayerSettings.SENTINEL_RUNE);
		this.despawn();
	}
}
